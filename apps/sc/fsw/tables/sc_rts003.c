...
SC_RtsTable003_t SC_Rts003 = {
    ...
    .rts.cmd1.CommandHeader = CFE_MSG_CMD_HDR_INIT(0x1882, SC_MEMBER_SIZE(cmd1), 2, 0xA6),

    /* 2 */
    .rts.hdr2.WakeupCount       = 5,
    .rts.cmd2.CommandHeader = CFE_MSG_CMD_HDR_INIT(0x1882, SC_MEMBER_SIZE(cmd2), 2, 0xA6),

    /* 3 */
    .rts.hdr3.WakeupCount       = 10,
    .rts.cmd3.CommandHeader = CFE_MSG_CMD_HDR_INIT(0x1882, SC_MEMBER_SIZE(cmd3), 2, 0xA6)};
