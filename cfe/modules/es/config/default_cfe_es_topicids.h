...
**      Not Applicable
*/
#define CFE_MISSION_ES_CMD_TOPICID     0 // 6
#define CFE_MISSION_ES_SEND_HK_TOPICID 1 // 8
...
#define CFE_MISSION_ES_APP_TLM_TOPICID      1 // 11
#define CFE_MISSION_ES_MEMSTATS_TLM_TOPICID 2 // 16
