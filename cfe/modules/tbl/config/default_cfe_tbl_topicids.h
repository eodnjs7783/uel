...
**      Not Applicable
*/
#define CFE_MISSION_TBL_CMD_TOPICID     7 // 4
#define CFE_MISSION_TBL_SEND_HK_TOPICID 8 // 12
...
**      Not Applicable
*/
#define CFE_MISSION_TBL_HK_TLM_TOPICID  10 // 4
#define CFE_MISSION_TBL_REG_TLM_TOPICID 11 // 12
